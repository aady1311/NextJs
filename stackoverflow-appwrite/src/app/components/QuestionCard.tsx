    ...
    return (
        ...
        >
            ...
            <div className="relative shrink-0 text-sm sm:text-right">
                <p>{(ques as any).totalVotes} votes</p>
                <p>{(ques as any).totalAnswers} answers</p>
            </div>
            <div className="relative w-full">
                ...
                >
                    <h2 className="text-xl">{(ques as any).title}</h2>
                </Link>
                <div className="mt-3 flex flex-wrap items-center gap-3 text-sm">
                    ...
                    <div className="ml-auto flex items-center gap-1">
                        <div className="w-6 h-6 bg-blue-500 rounded-lg flex items-center justify-center text-white font-semibold text-xs">
                        ...
                        <strong>&quot;{(ques as any).author.reputation}&quot;</strong>
                    </div>
