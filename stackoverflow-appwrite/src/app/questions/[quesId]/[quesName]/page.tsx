import Answers from "@/src/app/components/Answers";
import Comments from "@/src/app/components/Comments";
import { MarkdownPreview } from "@/src/app/components/RTE";
import VoteButtons from "@/src/app/components/VoteButtons";
import Particles from "@/src/app/components/magicui/particles";
...
import { TracingBeam } from "@/src/app/components/ui/tracing-beam";
                ...
                <div className="flex gap-4">
                    ...
                    <div className="w-full overflow-auto">
                        ...
                        {question.attachmentId && (
                            <div className="mt-3">
                                <img
                                    src={`${process.env.NEXT_PUBLIC_APPWRITE_HOST_URL}/storage/buckets/${questionAttachmentBucket}/files/${question.attachmentId}/view?project=${process.env.NEXT_PUBLIC_APPWRITE_PROJECT_ID}`}
                                    alt={question.title}
                                    className="rounded-lg w-64 h-48 object-cover border shadow-sm"
                                />
                            </div>
                        )}
